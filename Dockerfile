...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    apt -y install php7.4 apache2 php7.4-pear pkg-config libmongoc-1.0-0 php7.4-dev php7.4-xml php7.4-cli  php7.4-common php7.4-json php7.4-memcache php7.4-memcached php7.4-mysql && \
