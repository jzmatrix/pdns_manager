...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    apt -y install php7.4 apache2 php-pear pkg-config libmongoc-1.0-0 php-xml php7.0-xml php7.4-dev php7.4-xml php7.4-cli  php7.4-common && \
    apt -y install php7.4-bcmath php7.4-bz2 php7.4-cgi php7.4-curl php7.4-gd php7.4-geoip php7.4-gmp php7.4-imagick php7.4-intl php7.4-json php7.4-mbstring php7.4-mcrypt php7.4-memcache php7.4-memcached php7.4-mongodb php7.4-mysql php7.4-opcache php7.4-pspell php7.4-readline php7.4-snmp php7.4-tidy php7.4-xmlrpc php7.4-xsl php7.4-zip php-pear && \
    ###
